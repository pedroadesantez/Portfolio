...
const mockProject = {
  ...
  title: 'Test Project',
  description:
    'This is a test project description that showcases modern web development.',
...
describe('ProjectCard Component', () => {
  ...
  test('does not render live demo link when live is null', () => {
    ...
    expect(
      screen.queryByLabelText(/View Test Project live demo/)
  ...
  test('renders project image with correct alt text', () => {
    ...
    // Next.js Image component transforms the src, so we just check if the image is present
